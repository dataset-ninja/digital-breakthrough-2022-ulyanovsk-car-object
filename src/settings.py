...
BLOGPOST: Optional[Union[str, List[str], Dict[str, str]]] = {"Competition Page":"https://2022.hacks-ai.ru/championships/758259"}
REPOSITORY: Optional[Union[str, List[str], Dict[str, str]]] = {"GitHub":"https://github.com/teplov-andrew/Digital-breakthrough-2022"}

CITATION_URL: Optional[str] = None
AUTHORS: Optional[List[str]] = ["Andrew Teplov"]
AUTHORS_CONTACTS: Optional[List[str]] = ["https://www.kaggle.com/andrewteplov", "info-champ@hacks-ai.ru"]

ORGANIZATION_NAME: Optional[Union[str, List[str]]] = ["Government of the Ulyanovsk Region", "NordClan"]
ORGANIZATION_URL: Optional[Union[str, List[str]]] = ["https://ulgov.ru/", "https://nordclan.com/"]
